...
enum VisualizerAlgorithm { astar, dijkstra, bidir_dijkstra }
...
class Grid extends ChangeNotifier {
  ...
  void generateBoard(
      {@required GridGenerationFunction function,
...
class GridPainter extends CustomPainter {
  const GridPainter(this.rows, this.columns, this.unitSize, this.width,
      this.height, this.context);
